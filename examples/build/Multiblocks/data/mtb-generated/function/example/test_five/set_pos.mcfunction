...
execute at @s run function mtb-generated:example/test_five/place_blueprint/init_marker
function mtb:v0.1-alpha/find_id
kill @e[tag=mtb.example-test_five, predicate=mtb:v0.1-alpha/match_id,type=#mtb:v0.1-alpha/display]
