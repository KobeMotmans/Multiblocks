...
execute if score #success temp matches 0 if block ~ ~ ~ minecraft:air run return run execute unless score @s mtb_prev_state matches 0 run function mtb-generated:example/test_three/checking/spruce_stairs/waterlogged-false_half-bottom_facing-south_shape-outer_left/set_none
execute if score #success temp matches 0..1 run return run execute unless score @s mtb_prev_state matches 1 run function mtb-generated:example/test_three/checking/spruce_stairs/waterlogged-false_half-bottom_facing-south_shape-outer_left/set_wrong
execute unless score @s mtb_prev_state matches 2 run function mtb-generated:example/test_three/checking/spruce_stairs/waterlogged-false_half-bottom_facing-south_shape-outer_left/set_correct
