...
execute if score #mtb.debug_enabled temp matches 1 run tellraw @a[tag=mtb.debug] [{"text": "[Server]: Multiblocks v0.1.2-alpha loaded successfully","color":"green"}]
...
function mtb:v0.1.2-alpha/run_command {"command":"scoreboard objectives add mtb_copper_pick used:copper_pickaxe"}
...
function mtb:v0.1.2-alpha/run_command {"command":"scoreboard objectives add mtb_copper_axe used:copper_axe"}
...
function mtb:v0.1.2-alpha/run_command {"command":"scoreboard objectives add mtb_copper_shovel used:copper_shovel"}
...
function mtb:v0.1.2-alpha/run_command {"command":"scoreboard objectives add mtb_copper_hoe used:copper_hoe"}
...
schedule function mtb:v0.1.2-alpha/slow_tick 1t replace
