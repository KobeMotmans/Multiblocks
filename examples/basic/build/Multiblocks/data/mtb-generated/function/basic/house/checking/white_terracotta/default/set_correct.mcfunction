...
execute if score #mtb.debug_enabled temp matches 1 run tellraw @a[tag=mtb.debug] [{"text":"[Debug]: Correct block: minecraft:white_terracotta was placed","color":"green"}]
