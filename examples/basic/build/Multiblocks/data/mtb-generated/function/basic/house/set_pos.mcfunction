...
execute at @s run function mtb-generated:basic/house/place_blueprint/init_root
...
kill @e[tag=mtb.basic-house, predicate=mtb:v0.1.2-alpha/match_id, tag=!mtb.root,type=#mtb:v0.1.2-alpha/display]
