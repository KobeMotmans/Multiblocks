...
execute if score #mtb.debug_enabled temp matches 1 run tellraw @a[tag=mtb.debug] [{"text":"[Debug]: Correct block: minecraft:stripped_oak_log was placed","color":"green"}]
