...
execute align xyz positioned ~0.5 ~1.5 ~0.5 as @e[type=minecraft:block_display,tag=mtb.advanced-industrial_furnace,tag=mtb.root,predicate=advanced:match_search_id,limit=1] run function advanced:schematic/blueprint/place_mode/modify_blueprint