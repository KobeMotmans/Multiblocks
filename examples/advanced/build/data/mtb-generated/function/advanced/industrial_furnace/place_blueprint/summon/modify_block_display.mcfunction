$data merge entity @s {view_range:0.12f,transformation:{left_rotation:[0f,0f,0f,1f], right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.3f],scale:[0.6f,0.6f,0.6f]},block_state:$(display_data),Tags:["mtb.advanced-industrial_furnace", "$(block_id)"]}
