...
execute at @s run function mtb-generated:advanced/industrial_furnace/place_blueprint/init_root
...
kill @e[tag=mtb.advanced-industrial_furnace, predicate=mtb:v0.1.2-alpha/match_id, tag=!mtb.root,type=#mtb:v0.1.2-alpha/display]
