...
# written by theblackswitch https://github.com/TheBlackSwitch/switch-lib/wiki/%5BPLUGIN%5D-Aliases
...
def beet_default(ctx: Context):
    try:
        ...
        for alias in ctx.meta["aliases"]:
            ...
            ctx.require(find_replace(data_pack={"match": "mtb:*"}, substitute={"find": alias['regex'], "replace": alias['replace']}))
