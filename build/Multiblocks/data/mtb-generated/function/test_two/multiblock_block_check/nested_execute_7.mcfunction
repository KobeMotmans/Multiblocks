execute unless score @s got_block matches 0 unless block ~ ~ ~ minecraft:structure_block run function mtb-generated:test_two/multiblock_block_check/nested_execute_4
