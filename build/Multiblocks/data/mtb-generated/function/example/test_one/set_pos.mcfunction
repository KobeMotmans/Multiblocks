...
execute at @s run function mtb-generated:example/test_one/place_blueprint/init_marker
function mtb:v0.1-alpha/find_id
kill @e[tag=mtb.example-test_one, predicate=mtb:v0.1-alpha/match_id,type=#mtb:v0.1-alpha/display]
