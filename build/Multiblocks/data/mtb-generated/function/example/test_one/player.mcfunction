execute as @e[distance=..10,type=#mtb:display,tag=mtb.example-test_one] at @s align xyz positioned ~0.50 ~0.50 ~0.50 run function mtb-generated:example/test_one/checking/main
