...
execute at @s summon item_display run function mtb-generated:example/test_one/checking/oak_fence_gate/in_wall_false_powered_false_facing_south_open_false/rb_to_wb_nested
