...
execute at @s summon item_display run function mtb-generated:example/test_one/checking/oak_fence/east_true_waterlogged_false_south_false_north_true_west_false/rb_to_wb_nested
