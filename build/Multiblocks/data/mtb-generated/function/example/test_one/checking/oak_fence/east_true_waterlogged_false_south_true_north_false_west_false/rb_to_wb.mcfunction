...
execute at @s summon item_display run function mtb-generated:example/test_one/checking/oak_fence/east_true_waterlogged_false_south_true_north_false_west_false/rb_to_wb_nested
